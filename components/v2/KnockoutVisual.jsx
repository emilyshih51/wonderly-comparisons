export default function KnockoutVisual({ competitorName }) {
  return (
      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 border border-gray-200 text-center">
            ...
            <p className="text-xs text-gray-500 mt-2">$8,400 spent on platform fees</p>
          </div>
        </div>
        ...
        <div className="mt-10 text-center">
          <p className="text-2xl font-bold text-gray-900">
            That's <span className="wonderly-text">$8,400</span> you could spend on marketing, hiring, or literally anything else.
          </p>
        </div>
      </div>
    </div>
