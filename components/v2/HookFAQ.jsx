...
export default function HookFAQ({ competitorName }) {
  const [openIndex, setOpenIndex] = useState(0)

  // Hook-driven FAQs that address real objections
  const faqs = [
    {
  ...
  return (
    <div className="py-16 bg-white">
      <div className="max-w-2xl mx-auto px-6">
        ...
        {/* Hook headline - the most asked question */}
        <h2 className="text-3xl font-bold text-gray-900 mb-10 text-center">
          "Are you <span className="wonderly-text">really</span> free?"
